...
2. Repository name: `lawn-care-tracker` (or any name you want)
3. Description: "Track lawn maintenance activities"
4. Select "Public"
...
4. Name it "Lawn Care" and tap "Add"
...
2. Create a simple green square with 🏡 emoji
3. Export as PNG: 192x192px and 512x512px
